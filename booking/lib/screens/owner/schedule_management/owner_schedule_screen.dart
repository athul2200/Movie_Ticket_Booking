...
class _OwnerScheduleScreenState extends State<OwnerScheduleScreen> {
  ...
  final TextEditingController _dateCtrl = TextEditingController(text: '11/24/2023');
  
  final List<String> _timeSlots = [
    '10:00 AM', '01:30 PM', '04:45 PM', 
    '08:00 PM', '11:15 PM', '02:00 AM'
  ];
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Select Movie', style: Theme.of(context).textTheme.titleSmall),
                  const SizedBox(height: AppSpacing.xs),
                  AdminDropdown<String>(
                    value: _selectedMovie,
                    prefixIcon: const Icon(Icons.movie_creation_outlined, color: AppColors.textSecondary),
                    items: const [
                      DropdownMenuItem(value: 'Oppenheimer', child: Text('Oppenheimer')),
                  ...
                  Text('Select Screen', style: Theme.of(context).textTheme.titleSmall),
                  const SizedBox(height: AppSpacing.xs),
                  AdminDropdown<String>(
                    value: _selectedScreen,
                    prefixIcon: const Icon(Icons.grid_view_outlined, color: AppColors.textSecondary),
                    items: const [
                      DropdownMenuItem(value: 'Screen 01 (IMAX)', child: Text('Screen 01 (IMAX)')),
                      DropdownMenuItem(value: 'Screen 02', child: Text('Screen 02')),
                      DropdownMenuItem(value: 'Screen 03', child: Text('Screen 03')),
                    ],
                    onChanged: (val) {
                  ...
                  Text('Available Time Slots', style: Theme.of(context).textTheme.titleSmall),
                  ...
                  Wrap(
                    ...
                    children: _timeSlots.map((time) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          width: (MediaQuery.of(context).size.width - (AppSpacing.lg * 4) - AppSpacing.sm * 2) / 3,
            ...
            Row(
              children: [
                SizedBox(width: 80, child: Text('Screen', style: Theme.of(context).textTheme.bodyMedium)),
                Expanded(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('08 AM', style: Theme.of(context).textTheme.labelSmall),
                      Text('10 AM', style: Theme.of(context).textTheme.labelSmall),
                      Text('12 PM', style: Theme.of(context).textTheme.labelSmall),
                    ],
                  ),
                ),
              ],
            ...
            // Timelines
            _buildTimelineRow('SCR 01', 'Oppenheimer', '10:00 - 13:00', 0.3, 0.4, true),
            const SizedBox(height: AppSpacing.md),
            _buildTimelineRow('SCR 02', 'Barbie', '11:15 - 13:15', 0.5, 0.3, false),
            const SizedBox(height: AppSpacing.md),
            _buildTimelineRow('SCR 03', 'Dune 2', '09:00 - 11:45', 0.1, 0.35, false),
  ...
  Widget _buildTimelineRow(String screen, String movieTitle, String timeStr, double startPct, double widthPct, bool isSelected) {
    return Row(
      children: [
        SizedBox(
          width: 80,
