...
/// Compact booking layout matching standard items in Upcoming list
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.all(AppSpacing.md),
        decoration: BoxDecoration(
          color: const Color(0xFF7E7E7E), // Slate-grey theme
          borderRadius: BorderRadius.circular(AppRadius.lg),
        ),
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${booking.cinema} • Row ${booking.seats.isNotEmpty ? booking.seats.first[0] : 'B'}, Seat ${booking.seatsFormatted}',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                          color: AppColors.primary,
                          fontWeight: FontWeight.bold,
                          fontSize: 11,
